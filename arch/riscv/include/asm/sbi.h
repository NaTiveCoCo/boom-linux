...
enum sbi_ext_nacc_fid {
	SBI_EXT_NACC_REGISTER = 0x0,
    SBI_EXT_NACC_INVOKE = 0x1,
    SBI_EXT_NACC_RECLAIM_AGENT_REGION = 0x3,

    SBI_EXT_LINUX_VERIFY = 0x4,
    SBI_EXT_NACC_INVOKE_CHILD = 0x6,
    SBI_EXT_NACC_FORK = 0x7, /* reserved for removed legacy fork-bypass ABI */
    SBI_EXT_NACC_REEXEC = 0x8,
    SBI_EXT_NACC_SET_PTES = 0x9,
    SBI_EXT_NACC_ATTACH_FORKED_CHILD = 0xb,
    SBI_EXT_NACC_RETIRE_ROOT = 0xc,
    SBI_EXT_NACC_TAG_ROOT = 0xd,
    /* 0xe..0x13 reserved: obsolete context ABIs removed. */
    SBI_EXT_NACC_UPDATE_PTE = 0x14,
    SBI_EXT_NACC_UNREGISTER = 0x15,
    SBI_EXT_NACC_RETIRE_PRIVATE_PFN = 0x16,
    SBI_EXT_NACC_ACQUIRE_PRIVATE_PFN = 0x17,
    SBI_EXT_NACC_COPY_USER_HIGHPAGE = 0x18,
    SBI_EXT_NACC_UACCESS_SCOPE_BEGIN = 0x19,
    SBI_EXT_NACC_UACCESS_PRIVATE_GET_USER_READ = 0x1a,
    SBI_EXT_NACC_UACCESS_SCOPE_END = 0x1b,
    SBI_EXT_NACC_UACCESS_PRIVATE_COPY_TO_USER = 0x1c,
    SBI_EXT_NACC_UACCESS_PRIVATE_PUT_USER_WRITE = 0x1d,
    SBI_EXT_NACC_UACCESS_PRIVATE_COPY_FROM_USER = 0x1e,
    SBI_EXT_NACC_UACCESS_PRIVATE_CLEAR_USER = 0x1f,
    SBI_EXT_NACC_RECORD_VVAR = 0x22,
    SBI_EXT_NACC_ADOPT_VDSO = 0x23,
    SBI_EXT_NACC_UACCESS_PRIVATE_COPY_KERNEL_ALIAS = 0x24,
    SBI_EXT_NACC_FLUSH_AND_DRAIN = 0x29,
	SBI_EXT_NACC_FRESH_ZERO_LEAF = 0x2a,
	SBI_EXT_NACC_FORK_WINDOW_CHECK = 0x2b,
	SBI_EXT_NACC_FORK_SELECT_CHILD = 0x2c,
	SBI_EXT_NACC_COW_REPLACE = 0x2d,
	SBI_EXT_NACC_FORK_COPY_INSTALL = 0x2e,
